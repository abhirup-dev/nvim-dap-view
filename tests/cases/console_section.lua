...
-- "console" is a winbar section, so the terminal shares the dap-view window and
-- no separate terminal split is opened. This is the user's configuration
local sections = { "scopes", "watches", "breakpoints", "threads", "exceptions", "repl", "console" }
